---
created: 2018-08-18 17:18:05
jarvis_ai_meta:
  key_people: []
  mood: 平静
  summary: 用户阅读了关于Python re模块的教程，学习了正则表达式的基本用法和核心函数。
  tagged_at: '2026-01-11 02:40:29'
  time_space:
    date: '2018-08-18'
    location: ''
source: http://wiki.jikexueyuan.com/project/explore-python/Regular-Expressions/re.html
tags:
- 编程学习
- 极客学院
- Python
...
[点击这里成为作者](http://wiki.jikexueyuan.com/project/help) · 更新于 2018-08-18 17:00:45
