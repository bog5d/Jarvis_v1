...
jarvis_ai_meta:
  key_people: []
  mood: 平静
  summary: 作者（东围居士）在博客中分享了使用pandas的isin()方法筛选DataFrame特定行，并提供了排除特定行的变通方法。
  tagged_at: '2026-01-11 02:36:27'
  time_space:
    date: '2016-11-29'
    location: ''
...
[![unknown_filename.2.gif](./_resources/isin可以用来找特定行列.1.resources/unknown_filename.2.gif)](http://www.cnblogs.com/wuzhiblog/)
...
好文要顶 关注我 收藏该文 ![unknown_filename.5.png](./_resources/isin可以用来找特定行列.1.resources/unknown_filename.5.png) ![unknown_filename.1.png](./_resources/isin可以用来找特定行列.1.resources/unknown_filename.1.png)

[![unknown_filename.jpeg](./_resources/isin可以用来找特定行列.1.resources/unknown_filename.jpeg)](http://home.cnblogs.com/u/wuzhiblog/)
...
[![unknown_filename.3.jpeg](./_resources/isin可以用来找特定行列.1.resources/unknown_filename.3.jpeg)](https://dnspod.cloud.tencent.com/act/weapp?fromSource=gwzcw.781158.781158.781158)
...
[![unknown_filename.4.jpeg](./_resources/isin可以用来找特定行列.1.resources/unknown_filename.4.jpeg)](http://click.aliyun.com/m/34770/)
